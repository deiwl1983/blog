                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> 个人设置 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="${ctx}/admin/photo/editInfo" data-part>修改个人信息</a></li>
                      
                    </ul>
                  </li>
                  <li><a><i class="fa fa-edit"></i> 管理员操作 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="${ctx}/admin/adminOperation/adminInfo" data-part>管理员信息操作</a></li>
                      <li><a href="${ctx}/admin/photo/editInfo" data-part>修改个人信息</a></li>

                    </ul>
                  </li>
                  <li><a><i class="fa fa-edit"></i> 我的相册 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="${ctx}/admin/photo/upImg" data-part>上传相册</a></li>
                      <li><a href="${ctx}/admin/photo/showImg" data-part>显示图片</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-edit"></i> 慢生活 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="${ctx}/admin/photo/literature" data-part>交文识友</a></li>
                      <li><a href="${ctx}/admin/photo/editLiterature" data-part>编辑作品</a></li>
